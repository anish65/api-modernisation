...
@Component
public class TxnAPIExceptionHandler extends AbstractErrorWebExceptionHandler {

    public TxnAPIExceptionHandler(ErrorAttributes errorAttributes, WebProperties.Resources resources,
    ...
    Mono<ServerResponse> renderException(ServerRequest request) {
