...
public class FundTransferFailureEventListener implements KafkaConsumer<String, FundTransferRSMessage> {

    private final TransactionService transactionService;

    @SneakyThrows
    @Override
    @KafkaListener(topics = "${kafka.consumer.topic.fund-transfer-failure}",
            groupId = "${kafka.consumer.group-id.fund-transfer-failure}")
